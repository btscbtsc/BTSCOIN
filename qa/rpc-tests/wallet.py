...
#   c) node1 mines 32 blocks, so now node 0 has 500000BTSC, node 1 has 4250BTSC, node2 has none.
#   d) node0 sends 601 BTSC to node2, in two transactions (301 BTSC, then 300 BTSC).
