...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"BTSCOIN", "mnbudget", &mnbudget, true, true, false},
        {"BTSCOIN", "preparebudget", &preparebudget, true, true, false},
        {"BTSCOIN", "submitbudget", &submitbudget, true, true, false},
        {"BTSCOIN", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BTSCOIN", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BTSCOIN", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BTSCOIN", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BTSCOIN", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BTSCOIN", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BTSCOIN", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BTSCOIN", "checkbudgets", &checkbudgets, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31230/\n";
}
