...
Intro
-----
BTSCOIN (BTSC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BTSCOIN utilizes an energy efficient proof-of-stake algorithm, 
...
BTSCOIN Core is the original BTSCOIN client and it builds the backbone of the network.
