...
In order to support loading of multiple wallets in btscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is btscoin.cpp.
...
Changes to btscoin.cpp
----------------------
btscoin.cpp is the entry point into btscoin-qt, and as such, will require some minor modifications to provide hooks for
